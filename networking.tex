...
\caption{Rappresentazione grafica di un segnale sinusoidale}
\end{figure}
...
\caption{Confronto tra tipologie di modulazione ad onda continua}
\end{figure}
...
\subsub{RARP} 
%\subsub{NDP} 
%ARP, RARP da spostare nel lv. di rete
...
\caption{Suddivisione in classi degli indirizzi IPv4}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{ifconfig.png}
\caption{Output del comando ifconfig su una macchina Linux}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Output del comando \code{netstat -r}}\end{figure}
