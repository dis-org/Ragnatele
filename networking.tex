...
\subsection{Terminologia} 
\subsub{URI} Uniform Risource Identifier: sequenza di caratteri che identifica univocamente una risorsa. Esistonon due tipi di URI:
\begin{itemize}
...
\end{itemize}
\sub{NAT}
Network Address Translation: servizio svolto da un router posto tra due reti differenti, normalmente una privata e una pubblica, che consiste nel modificare gli indirizzi IP contenuti negli header dei pacchetti che transitano al suo interno.\\
 ...
 \begin{itemize}
 	\item L'\vedi{Indirizzo IP} che identifica il nodo di rete;
 	\item Il port number che identifica, all’interno del particolare nodo di rete, quale programma riceve effettivamente il messaggio.
 \end{itemize}
