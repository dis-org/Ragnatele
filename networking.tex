...
\subsub{Indirizzo IP} Numero che identifica univocamente i dispositivi nell'ambito di una rete. In particolare l'IPv4, su 4 byte, è in forma $x.y.z.q$ e suddiviso in due parti, \textit{rete} ed \textit{host}. Gli indirizzi IP si suddividono in classi a seconda del numero di byte dedicato alla rete:
\begin{figure}[h]
\centering
