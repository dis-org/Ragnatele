...
\subsub{VRC}
Il VRC (Controllo di Ridondanza Verticale) consiste nell'aggiungere un solo bit di valore 1 al messaggio, in modo tale da rendere pari (o dispari) il numero di bit con tale valore per verificare se il messaggio è alterato. Questo metodo é semplice e pratico ma gestisce pochi errori poichè se gli errori sono tali da non cambiare la parità non funziona.
\subsub{LRC}
