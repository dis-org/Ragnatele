...
\\Nel corso dell'attraversamento di una catena, si controlla se il pacchetto soddisfa il campo \textit{match}: se così accade, il pacchetto subirà il \textit{target} e le regole successive saranno ignorate, altrimenti verranno applicate le regole base, definibili a loro volta tramite \code{iptables}.\\
