...
Si utilizza quando si presenta la necessità di trasmettere i segnali digitali sulla linea telefonica e viceversa. Occorre notare che la banda disponibile sulla linea telefonica solamente $4 kHz$, il che rende inefficiente la trasmissione del segnale digitale su di essa; in particolare per via dell'\vedi{Attenuazione} delle alte frequenze e per la scarsissima velocità di trasferimento. Un modem fonico opera dunque una \vedi{Modulazione digitale} volta a comprimere il la banda dei segnali emessi dal \vedi{DTE}.
...
\item QAM V.29;
\item QAM V.32, che utilizza una variante della QAM, la TCM, ed implementa la \textit{soppressione dell'eco}. %da spiegare sia la Trellis Code Modulation, sia la soppressione dell'eco
\end{itemize}
