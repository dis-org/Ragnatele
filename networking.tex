...
\begin{itemize}
\item sincrona: gli intervalli di tempo sono indipendenti dalla presenza di dati da spedire;
\item statistica: gli intervalli vengono allocati solo quando ci sono dati da inviare. La velocità complessiva è solitamente minore della somma delle velocità dei canali.
\end{itemize}
\sub{Modulazione}
