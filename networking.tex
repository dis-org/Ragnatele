...
L' host A, per sapere l' indirizzo fisico di B, invierà una richiesta ARP a tutti gli host (contenente ip di B e il MAC address di A), B vedendo una chiamata con il suo IP, risponde segnando il MAC address di A in una cache di consultazione e riinviando il proprio mac address ad A.\\
