...
\subsub{FTP} %SCP standard odierno
...
\para{Nome di dominio} Costituito da una serie di stringhe separate da punti, la gerarchia procede da destra verso sinistra, partendo dalla prima stringa   detta \italic{Top Level Domain} (TLD)
