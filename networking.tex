...
Nonostante eststano diversi tipi di ethernet, la struttura del pacchetto è la stessa.
%immagine
...
\begin{itemize}
    ...
    \italic{Start Frame Delimiter}
    \item \italic{Destination MAC Address}(indirizzo destinazione):si 6 byte, condiene l' indirizzo fisico del ricevente, se non corrisponde il pacchetto viene scartato al \vedi{Livello Fisico}.
    \item \italic{Source MAC Address} (indirizzo sorgente): di 6 byte.
    \item \italic{Ether Type}(campo tipo):   
