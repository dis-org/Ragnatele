...
\begin{itemize}
\item \italic{\textbf{primary}}, qualora gestisca esso stesso le informazioni relative al proprio dominio, salvate negli \vedi{Zone files}, configurati dall'amministratore di rete,
\item \italic{\textbf{secondary}}: scaricano gli \vedi{Zone files} dal primary server e li memorizzano in appositi file detti \italic{zone file transfer}.
\end{itemize}
\end{itemize}
