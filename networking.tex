...
La Posta Elettronica \'e composta da due programm:i il Mail User Agent ed il Programma di Trasporto(SendMail). Il primo \'e un interfaccia verso l'applicazione utilizzata \'e composto da:
 \begin{itemize}
 	\item Composizione 
