...
\subsub{Modem} 
Un modem (contrazione di modulatore/demodulatore) è un \vedi{DCE} con funzionalità di \vedi{Modulazione} in trasmissioni analogiche \textit{e} digitali. Risulta particolarmente utile, ad esempio, nel momento in cui si presenta la necessità di trasmettere i segnali digitali sulla linea telefonica e viceversa (si parla in tal caso di \textbf{modem fonico}). Altri tipi di modem sono:
\begin{itemize}
