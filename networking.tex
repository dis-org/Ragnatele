...
\\Rimane fondamentalmente uno strumento teorico e concettuale con uno scarsissimo numero di implementazioni di servizi.
...
e di applicazione:
\begin{itemize}
	\item Programma che elabora i dati ed eroga servizi
\end{itemize}
