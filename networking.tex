...
\subsection{Nozione di protocollo} 
Un protocollo di rete è un insieme di regole formalmente descritte che definisce le modalità di comunicazione due nodi.
%Gioara 
...
Un parametro interessante in ambito di comunicazione dati è la velocità di trasferimento, espressa in $bit/sec$. Preliminarmente, occorre intendersi sul tipo di canale interessato, distinguendo:
\begin{itemize}
